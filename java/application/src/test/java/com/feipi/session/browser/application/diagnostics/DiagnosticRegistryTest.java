...
import com.feipi.session.browser.application.diagnostics.DiagnosticRegistry.AnomalyDefinition;
import com.feipi.session.browser.application.diagnostics.DiagnosticRegistry.SignalDefinition;
