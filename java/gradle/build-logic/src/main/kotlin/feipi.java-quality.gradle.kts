...
checkstyle {
    ...
    configDirectory.set(buildRoot.dir("gradle/config/checkstyle"))
    configFile = buildRoot.file("gradle/config/checkstyle/checkstyle.xml").asFile
...
pmd {
    ...
    ruleSetFiles = files(buildRoot.file("gradle/config/pmd/pmd.xml"))
    ruleSets = listOf()
    isIgnoreFailures = false
