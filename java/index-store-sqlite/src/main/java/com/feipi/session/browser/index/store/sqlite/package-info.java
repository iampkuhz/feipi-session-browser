/**
 * {@code index-store-sqlite} 模块：SQLite schema、连接运行时与 migration 管理。
 *
 ...
 * {@link com.feipi.session.browser.index.store.sqlite.row.SessionRow} 紧凑构造器，只检查 DB 约束所需的非空和非负条件。
 */
package com.feipi.session.browser.index.store.sqlite;
