 ...
 * </ul>
 */
public final class SqliteSessionResultSetMapper {
  ...
  /** 防止实例化。 */
  private SqliteSessionResultSetMapper() {}
   ...
   */
  public static SessionRow mapRow(ResultSet rs) throws SQLException {
    return new SessionRow(
        rs.getString("session_key"),
        rs.getString("agent"),
        rs.getString("session_id"),
        SqliteSqlUtils.nullToEmpty(rs.getString("title")),
        SqliteSqlUtils.nullToEmpty(rs.getString("project_key")),
        SqliteSqlUtils.nullToEmpty(rs.getString("project_name")),
        SqliteSqlUtils.nullToEmpty(rs.getString("cwd")),
        SqliteSqlUtils.nullToEmpty(rs.getString("started_at")),
        ...
        SqliteSqlUtils.nullToEmpty(rs.getString("model")),
        SqliteSqlUtils.nullToEmpty(rs.getString("git_branch")),
        SqliteSqlUtils.nullToEmpty(rs.getString("source")),
        ...
        SqliteSqlUtils.nullToEmpty(rs.getString("file_path")));
  }
}
