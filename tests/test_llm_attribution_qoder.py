...
Verifies:
1. Qoder cache split is unknown — no fake cache_read/cache_write.
2. Qoder uses transcript-level reconstruction.
...
def test_qoder_cache_split_unknown():
    """Qoder must NOT fabricate cache_read / cache_write values."""
...
def test_qoder_availability_notes_cache_unknown():
    """Availability rows should note that cache split is unknown."""
