...
from scripts.checks.privacy import check_no_committed_local_paths as local_paths
from scripts.checks.privacy import check_no_real_session_fixtures as real_sessions
