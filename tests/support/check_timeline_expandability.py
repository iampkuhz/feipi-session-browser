...
_WEB_RESOURCES = _TOOL_DIR / 'java' / 'web' / 'src' / 'main' / 'resources'
TEMPLATES = _WEB_RESOURCES / 'templates'
STATIC_JS = _WEB_RESOURCES / 'static' / 'js'
STATIC_CSS = _WEB_RESOURCES / 'static' / 'css' / 'session-detail' / '04-timeline.css'
...
def run() -> int:
    ...
    # 加载文件。
    timeline_html = _read(TEMPLATES / 'session.html')
