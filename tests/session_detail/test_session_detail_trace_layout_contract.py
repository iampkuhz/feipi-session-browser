...
class TestRoundRowLayout:
    ...
    def test_expanded_row_hidden(self):
        ...
        assert any('none' in b for b in blocks), '.expanded-row must have display: none by default'
...
class TestTemplateStructure:
    ...
    def test_trace_row_has_trace_round(self):
        ...
        assert 'sdt.trace_round' in content, 'session.html must call sdt.trace_round macro'
    ...
    def test_trace_row_has_token_mix(self):
        ...
        assert 'tokenbar' in css or 'sd-tokenbar' in css, 'CSS must include token bar styles'
