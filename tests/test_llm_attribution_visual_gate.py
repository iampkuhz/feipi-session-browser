...
class TestTextCheckHelpers:
    ...
    def test_request_all_required_pass(self):
        text = "基于本地日志重建，不等同于真实 provider request/response body。用量分布 归因明细 可见内容摘要 参数可得性表 不计入总量 定位率 未定位"
    ...
    def test_request_exclusion_label_relaxed_when_no_display_only_section(self):
        ...
        text = "基于本地日志重建，不等同于真实 provider request/response body。用量分布 归因明细 可见内容摘要 参数可得性表 定位率 未定位"
    ...
    def test_request_exclusion_label_still_required_with_display_only_section(self):
        ...
        text = "基于本地日志重建，不等同于真实 provider request/response body。用量分布 归因明细 可见内容摘要 参数可得性表 定位率"
    ...
    def test_response_exclusion_label_relaxed_when_no_display_only_section(self):
        ...
        text = "基于本地日志重建，不等同于真实 provider request/response body。用量分布 归因明细 Blocks 明细 可见内容摘要 参数可得性表 定位率 未定位"
    ...
    def test_response_all_required_pass(self):
        text = "基于本地日志重建，不等同于真实 provider request/response body。用量分布 归因明细 Blocks 明细 可见内容摘要 参数可得性表 不计入总量 定位率 未定位"
