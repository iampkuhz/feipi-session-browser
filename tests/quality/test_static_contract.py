...
class TestCheckNoImportant:
    ...
    def test_clean_css_passes(self, tmp_path: Path):
        css = tmp_path / 'clean.css'
        css.write_text('.foo { color: red; }')
        assert check_no_important([css]) == []

    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_important_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_important_in_comment_still_matches(self, tmp_path: Path):
...
class TestCheckNoDeadCss:
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_only_comments_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_empty_file_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_only_whitespace_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_comment_with_rules_passes(self, tmp_path: Path):
...
class TestCheckNoDuplicateBaseCss:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_base_html_skipped(self, tmp_path: Path):
        """base.html 本身应被跳过."""
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_without_base_css_passes(self, tmp_path: Path):
        """页面模板仅有页面级 CSS 应通过."""
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_with_tokens_css_blocks(self, tmp_path: Path):
        """页面加载 tokens.css 应拦截."""
        page = tmp_path / 'dashboard.html'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_with_base_css_blocks(self, tmp_path: Path):
        """页面加载 base.css 应拦截."""
        page = tmp_path / 'dashboard.html'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_with_multiple_base_css_blocks(self, tmp_path: Path):
        """页面加载多个基础 CSS 应全部列出."""
...
class TestCheckPayloadModalOwnership:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_ui_primitives_exempt(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_bare_payload_modal_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_scoped_not_warn(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_level_payload_modal_passes(self, tmp_path: Path):
        """页面级 .session-detail-page .payload-modal 不应拦截."""
        css = tmp_path / 'session-detail.css'
        css.write_text('.session-detail-page .payload-modal { width: 80vw; }')
        errors, warnings = check_payload_modal_ownership([css])
...
class TestCheckShellOwnership:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_shell_css_exempt(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_base_css_exempt(self, tmp_path: Path):
        """base.css 是基础文件,不应告警."""
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_tokens_css_exempt(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_css_warns(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_body_hide_left_warns(self, tmp_path: Path):
...
class TestCheckInnerhtmlSafety:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_no_innerhtml_passes(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_innerhtml_with_escape_passes(self, tmp_path: Path):
        """InnerHTML 带 escapeHtml 辅助函数不应告警."""
        js = tmp_path / 'safe.js'
        js.write_text('function escapeHtml(s) { return s; }el.innerHTML = escapeHtml(userInput);')
        warnings = check_innerhtml_safety([js])
        assert warnings == []

    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_innerhtml_with_sanitize_passes(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_innerhtml_without_safety_warns(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_innerhtml_clearing_not_warned(self, tmp_path: Path):
...
class TestCheckCssOwnershipGate:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_clean_page_css_passes(self, tmp_path: Path):
        css = tmp_path / 'dashboard.css'
        css.write_text('.dashboard-page .card { padding: 16px; }')
        assert check_css_ownership_gate([css]) == []

    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_shell_selector_in_page_blocks(self, tmp_path: Path):
        """页面 CSS 定义 .shell 应拦截."""
        css = tmp_path / 'dashboard.css'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_app_shell_in_page_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_body_state_in_page_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_tokens_with_selector_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_page_grid_template_allowed(self, tmp_path: Path):
...
class TestCheckNoGlobalComponentOverride:
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_bare_data_table_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_bare_btn_blocks(self, tmp_path: Path):
        """页面 CSS 含裸 .btn 应拦截."""
        css = tmp_path / 'dashboard.css'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_bare_modal_blocks(self, tmp_path: Path):
        """页面 CSS 含裸 .modal 应拦截."""
        css = tmp_path / 'page.css'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_scoped_selector_allowed(self, tmp_path: Path):
        """页面级后代选择器是允许的."""
        css = tmp_path / 'dashboard.css'
...
class TestCheckSelectorDepthNewBlock:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_shallow_selectors_pass(self, tmp_path: Path):
        css = tmp_path / 'clean.css'
        css.write_text('.foo { color: red; }\n.foo .bar { margin: 0; }')
        assert check_selector_depth_new_block([css]) == []

    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_depth_3_passes(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_depth_4_blocks(self, tmp_path: Path):
        """深度 > 3 应拦截."""
        css = tmp_path / 'bad.css'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_child_combinator_counts(self, tmp_path: Path):
        """子组合器计入深度."""
        css = tmp_path / 'bad.css'
        css.write_text('.a > .b + .c .d { color: red; }')
        errors = check_selector_depth_new_block([css])
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_pseudo_class_not_extra(self, tmp_path: Path):
        """伪类不增加深度."""
        css = tmp_path / 'ok.css'
...
class TestCheckNoRawInnerhtmlNewBlock:
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_clean_js_passes(self, tmp_path: Path):
        js = tmp_path / 'clean.js'
        js.write_text('var x = 1;')
        assert check_no_raw_innerhtml_new_block([js]) == []

    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_raw_innerhtml_blocks(self, tmp_path: Path):
        """裸 innerHTML = 应拦截."""
        js = tmp_path / 'unsafe.js'
        js.write_text("el.innerHTML = '<div>' + userInput + '</div>';")
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_innerhtml_clear_allowed(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_escapehtml_helper_passes(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_dompurify_passes(self, tmp_path: Path):
...
class TestCheckNoLayoutInlineStyleNewBlock:
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_custom_property_only_passes(self, tmp_path: Path):
        """纯 CSS 自定义属性不应拦截."""
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_mixed_custom_property_blocks(self, tmp_path: Path):
        """自定义属性 + layout 属性应拦截."""
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_template_variable_skipped(self, tmp_path: Path):
        """模板变量注入应被跳过."""
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_js_style_display_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_js_style_position_blocks(self, tmp_path: Path):
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_js_style_width_blocks(self, tmp_path: Path):
        """JS .style.width = 应拦截."""
        js = tmp_path / 'bad.js'
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_js_comment_skipped(self, tmp_path: Path):
        """JS 注释中的 .style 应被跳过."""
        js = tmp_path / 'comment.js'
        js.write_text("// el.style.display = 'none';")
    ...
    @pytest.mark.contract_case('HOOK-HARNESS-013')
    def test_new_important_blocks(self, tmp_path: Path):
