...
from session_browser.attribution.collectors.history.prior_messages_extractor import extract_prior_messages
from session_browser.attribution.collectors.history.prior_tool_results_extractor import extract_prior_tool_results
...
class TestPriorToolResultsExtractor:
    def test_extract_prior_tool_results(self):
        messages = [
            {"role": "user", "content": [
                {"type": "tool_result", "tool_use_id": "t-001", "content": [{"text": "Result 1"}]},
            ]},
