...
_RUNTIME_ROOT = Path(
    os.environ.get('FEIPI_AGENT_RUNTIME_ROOT', REPO_ROOT / 'tmp' / 'agent-runtime')
)
DEFAULT_OUT = (
    _RUNTIME_ROOT / 'runs' / _RUN_ID / 'test-results' / 'quality' / 'llm-attribution-visual'
)
