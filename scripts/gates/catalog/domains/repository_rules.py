...
GATES = (
    ...
    Gate(
        ...
        trigger=changed(
            ...
            'java/tests/**/*.js',
            'java/tests/**/*.ts',
            'java/tests/playwright/playwright.config.js',
    ...
    Gate(
        ...
        trigger=changed(
            ...
            'scripts/tests/quality/test_current_version.py',
        ),
        target_presets=('gate-infrastructure',),
        recipe=recipe(
            10,
    ...
    Gate(
        ...
        trigger=changed(
            ...
            'scripts/tests/checks/test_acceptance_traceability.py',
    ...
    Gate(
        ...
        recipe=recipe(
            ...
            python_check(
                ...
                'scripts',
                '--policy',
                '{repo_root}/scripts/gates/config/technical-terms.json',
            ),
        ),
    ),
)
