...
| 关联测试 | `tests/playwright/sessions-list.spec.js`、`tests/playwright/sessions-list.spec.js`、`tests/playwright/sessions-list.spec.js`、`java/web/src/test/java/com/feipi/session/browser/web/page/QueryParamsTest.java`、`tests/playwright/sessions-list.spec.js`、`tests/playwright/sessions-list.spec.js` |
...
|---|---:|---|---|---|---|---|---|---|
| UI-SESSIONS-001 | P0 | visual | 会话列表核心结构 | 真实浏览器访问 sessions | page head、filters 和 API rows table 可见 | Playwright | — | `tests/playwright/sessions-list.spec.js` |
...
| UI-SESSIONS-016 | P1 | visual | token 单元格契约 | 检查真实 tokenbar | 单元格含四段 tokenbar 且 API 数值 invariant 成立 | Playwright | — | `tests/playwright/sessions-list.spec.js` |
