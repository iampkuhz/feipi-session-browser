...
| HOOK-HARNESS-006 | P0 | data | Stop hook Git 变更真相 | 测试 Stop changed-files resolver | committed、dirty、untracked 变更都被纳入 Stop 判定 | pytest | — | `tests/harness/test_stop_helpers.py` |
