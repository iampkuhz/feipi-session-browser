...
- [ ] 诊断区覆盖 Main Agent Breakdown、Context Budget、Tool Impact、Subagent Breakdown、Issues & Repro Seeds；Top Cost Drivers、Call Cost Distribution 和 Payload Availability 不再独立渲染。
